...
urlpatterns = [
    ...
    path("seleccionarOrden/<idorden>", views.seleccionarOrden, name="seleccionarOrden"),
    path("borrarOrden/<idorden>", views.borrarOrden, name='borrarOrden'),  # Ruta para eliminar una orden
